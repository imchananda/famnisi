                        ...
                        <td className="px-4 py-4">
                          <div className="flex items-center justify-center gap-2">
                            <button
                              ...
                              className="flex h-9 w-9 items-center justify-center rounded-xl border border-[#d8b3ad] bg-white text-[#6f1d2c] transition hover:border-[#8d2334] hover:bg-[#fff4f1]"
                              aria-label={t.edit}
                              title={t.edit}
                            >
                            ...
                            <button
                              ...
                              className="flex h-9 w-9 items-center justify-center rounded-xl border border-[#ead3cc] bg-white text-[#7c6864] transition hover:border-[#8d2334] hover:bg-[#8d2334] hover:text-white"
                              aria-label={t.delete}
                              title={t.delete}
                            >
                              <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
